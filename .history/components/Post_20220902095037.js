    ...
    <div className="flex p-3 cursor-pointer border-b border-gray-200">
        ...
        {/* Header */}
            ...
            <div className="flex justify-between text-gray-500">
                ...
                <TrashIcon className="h-9 w-9 hoverEffect p-2 hover:text-red-600 hover:bg-sky-100"/>
                <HeartIcon className="h-9 w-9 hoverEffect p-2 hover:text-red-600 hover:bg-sky-100"/>
