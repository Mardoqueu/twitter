  ...
  return (
    <div className="flex border-b border-gray-200 p-3 space-x-3">
        ...
        <div className="w-full">
            <div className="">
                <textarea className="w-full border-none focus:ring-0 text-lg placeholder-gray-700 tracking-wide mini-h-[50px]"  rows="2" placeholder="What's happening?"></textarea>
            </div>
            <div className="">
