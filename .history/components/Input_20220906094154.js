    ...
    {session && (
        ...
        <div className="w-full divide-y divide-gray-200">
            ...
            <div className="flex items-center justify-between pt-2.5">
                ...
                <button onClick={sendPost} disabled={!input.trim()} className="bg-blue-400 text-white px-4 py-1.5 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-100">Tweet</button>            
            </div>
        </div>
    </div>
