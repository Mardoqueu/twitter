...
export default function Sidebar() {
  return (
    <div>
        ...
        {/* Mini-profile */}
        <div className="">
            <img src="https://media-exp1.licdn.com/dms/image/C4E03AQF1Icbg9ibKSQ/profile-displayphoto-shrink_800_800/0/1656524327808?e=1667433600&v=beta&t=zLj1VuO7UnlyGXgtGnCIGGm6Xel0rldXOa9ES50GV3c" alt=""/>
        </div>  
    </div>
  )
}
